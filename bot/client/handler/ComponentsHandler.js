...
class ComponentsHandler {
    ...
    load = () => {
        for (const directory of readdirSync('./bot/components/')) {
            for (const file of readdirSync('./bot/components/' + directory).filter((f) => f.endsWith('.js'))) {
                try {
                    /**
                    ...
                    error('Unable to load a component from the path: ' + 'bot/component/' + directory + '/' + file);
                }
            }
        }
