...
const handleApplicationCommandOptions = async (interaction, options, command) => {
    // Check if the command is guild-only and ensure it's being used in a guild
    if (options.guildOnly && !interaction.guild) {
        await interaction.reply({
            content: config.messages.GUILD_ONLY || 'This command can only be used in a server',
